...
## Introduction
  ...
  As stated, I am not a professional and I'm attempting to write this tutorial in layman's terms (or as close to it as possible).  If you notice that I've phrased anything in a way that in just plain wrong, please notify me.  I was this guide to be accurate, and to a degree, as technical as it can be without becoming unreadable and non-understandable to someone new to programming in general.
